...
def main():
    ...
    #imlist_posi_x_cap.extend(imlist_nega_x_cap)
    
    # Decode
    img_index_x = pattern.decode(imlist_posi_x_cap, thresh=thresh)
    ...
    # Decode
    img_index_y = pattern.decode(imlist_posi_y_cap, thresh=thresh)
    ...
    plt.imsave('imageXY_Binary.png',img_correspondence,cmap='gray')
