...
// Custom messages
#define WM_NEW_GRABRESULT       (WM_APP + 1) // wparam = camindex
#define WM_DEVICE_REMOVED       (WM_APP + 2) // wparam = camindex
#define WM_NODES_UPDATED        (WM_APP + 3) // wparam = camindex
#define WM_GRAB_STATE_CHANGED   (WM_APP + 4) // wparam = camindex, lparam=IsGrabbing()
